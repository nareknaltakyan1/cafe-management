package com.sflpro.cafe.validator;
...
public class FileValidator
{
	...
	private static final List<String> ACCEPTED_CONTENT_TYPES = Arrays.asList("image/jpeg", "image/jpg", "image/png", "application/pdf", "video/mp4",
		"video/quicktime", "text/html", "application/xlsx");

	private static final List<String> ACCEPTED_EXTENSIONS = Arrays.asList("jpeg", "jpg", "png", "mpeg", "pdf", "mp4", "mov", "html", "xlsx");
